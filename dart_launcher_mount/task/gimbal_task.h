...
#define GIMBAL_MAX_SPEED    	8192*6

#define AUTO_LEFT_LIMIT 		-184635
#define AUTO_RIGHT_LIMIT 		-196668

#define GIMBAL_VISION_DEADBAND 	1
...
typedef enum{
	GIMBAL_SCREEN_TEST_MODE,
	GIMBAL_SCREEN_GAME_MODE,
